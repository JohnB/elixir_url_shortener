...
# ElixirUrlShortenerWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :elixir_url_shortener, ElixirUrlShortenerWeb.Endpoint, server: true
#

# Finally import the config/prod.secret.exs
# which should be versioned separately.
#import_config "prod.secret.exs"
# RECOMMENDED BY GIGALIXIR
config :elixir_url_shortener, ElixirUrlShortenerWeb.Endpoint,
  load_from_system_env: true,
